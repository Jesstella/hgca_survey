...
ra_acceleration = ['%.2f' % elem for elem in ra_acceleration]
dec_acceleration = ['%.2f' % elem for elem in dec_acceleration]
ra_acceleration_error = ['%.2f' % elem for elem in ra_acceleration_error]
dec_acceleration_error = ['%.2f' % elem for elem in dec_acceleration_error]
astrometric_accel = ['%.2f' % elem for elem in astrometric_accel]
full_acceleration_error = ['%.2f' % elem for elem in full_acceleration_error]
